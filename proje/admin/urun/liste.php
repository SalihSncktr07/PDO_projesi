...
Sil</a>";
    echo "<a href='ekle.php' class='col-xs col-md btn btn-primary m-b-1em pullleft'><span class='glyphicon glyphicon glyphicon-plus'></span> Yeni Ürün</a>";
    ?>
    <!-- ürün arama formu -->
        ...
        <div class="row">
            <div class="col-xs-6 col-md-4 pull-right">
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="Ürün ara" name="aranan" value="<?php echo isset($_GET['aranan']) ? $_GET['aranan'] : ""; ?>" />
